    ...
    <div class="row">
          ...
          <ul class="comment-list">
            <li class="comment">
              ...
              <div class="comment-body">
                <h3>John Doe</h3>
                <div class="meta">August 18, 2020 at 2:21pm</div>
      ...
      <div class="col-lg-4 sidebar ftco-animate">
        ...
        <div class="sidebar-box ftco-animate">
         ...
         <ul class="categories">
          <li><a href="#">Pet Adoption <span>(12)</span></a></li>
          <li><a href="#">Pet Grooming <span>(22)</span></a></li>
          <li><a href="#">Vaccination <span>(37)</span></a></li>
          <li><a href="#">Dog Training <span>(42)</span></a></li>
          <li><a href="#">Pet Daycare <span>(42)</span></a></li>
          <li><a href="#">Pet Sitter <span>(42)</span></a></li>
          <li><a href="#">Veterinary Help <span>(42)</span></a></li>
        </ul>
      </div>
      ...
      <div class="sidebar-box ftco-animate">
        ...
        <div class="tagcloud">
          ...
          <a href="#" class="tag-cloud-link">grooming</a>
          <a href="#" class="tag-cloud-link">vaccine</a>
          <a href="#" class="tag-cloud-link">animal</a>
