  ...
  <input type="hidden" name="_token" value="{{ csrf_token() }}">
    ...
    <div class="row">
		...
		<div class="col-md-6">
	         ...
	         <input type="text" palceholder="Enter Your Address">		
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-6">
	         ...
	         <input type="text" palceholder="Enter Your Card Holder Name">		
		</div>
		<div class="col-md-6">
	         <label for="Credit-card-number">Credit-card-number</label><br>
	         <input type="text" palceholder="Enter Your Credit-card-number">		
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-6">
	         ...
	         <input type="text" palceholder="Enter Expiration Month<">		
		</div>
		<div class="col-md-6">
	         <label for="Expiration-Year">Expiration-Year</label><br>
	         <input type="text" palceholder="Enter Expiration-Year">		
		</div>
	</div>
    ...
    <div class="row"> 
      <input type="submit" value="BUY NOW" style="margin-left:30%;font-size:18px" class="btn btn-danger">
    </div>
  </form>
</div>
